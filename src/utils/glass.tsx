...
const glassStyles = {
	default:
		'bg-background-glass shadow-glass-light shadow-glass-dark backdrop-blur-md',
	fill: 'bg-background/60 backdrop-blur-[6px]',
	accent:
		'bg-accent-quaternary/80 shadow-glass-light-lg shadow-glass-dark-lg backdrop-blur-[6px]',
	...
	'', // No base styles - all applied conditionally
	{
		...
		compoundVariants: [
			// Always applied styles (hover: false) - base + glass
			{
				variant: 'default',
				hover: false,
				class: classNames(baseStyles, glassStyles.default),
			},
			{
				variant: 'fill',
				hover: false,
				class: classNames(baseStyles, glassStyles.fill),
			},
			{
				variant: 'accent',
				hover: false,
				class: classNames(baseStyles, glassStyles.accent),
			},
			{
				variant: 'subtle',
				hover: false,
				class: classNames(baseStyles, glassStyles.subtle),
			},
			...
			// Hover-only styles (hover: true) - everything on hover
			{
				...
				hover: true,
				class: classNames(
					toHoverStyles(baseStyles),
					toHoverStyles(glassStyles.default),
				),
			},
			{
				variant: 'fill',
				...
				class: classNames(
					toHoverStyles(baseStyles),
					toHoverStyles(glassStyles.fill),
				),
			},
			{
				variant: 'accent',
				...
				class: classNames(
					toHoverStyles(baseStyles),
					toHoverStyles(glassStyles.accent),
				),
			},
			{
				variant: 'subtle',
				...
				class: classNames(
					toHoverStyles(baseStyles),
					toHoverStyles(glassStyles.subtle),
				),
			},
		],
		defaultVariants: {
